#!/bin/bash
#SBATCH --job-name=separar_snv    # Job name
#SBATCH --output=separar_snv_%j.out       # Output file (%j expands to job ID)
#SBATCH --error=separar_snv_%j.err        # Error file
...
#Wrapper para separar archivos VCF en SNV/indel y SV
