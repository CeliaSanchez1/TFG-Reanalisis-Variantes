#!/bin/bash
#SBATCH --job-name=comparar_vcf_chrom     # Job name
#SBATCH --output=comparar_vcf_chrom_%A_%a.out
#SBATCH --error=vcomparar_vcf_chrom_%A_%a.err
...
#Wrapper para paralelizar por cromosomas la comparación de versiones de anotación 
...
#Descargar el archivo para integrar HPO y ejecutar la comparación
